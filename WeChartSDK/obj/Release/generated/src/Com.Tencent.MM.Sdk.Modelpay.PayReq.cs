...
namespace Com.Tencent.MM.Sdk.Modelpay {
	...
	public partial class PayReq : global::Com.Tencent.MM.Sdk.Modelbase.BaseReq {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.sdk.modelpay']/class[@name='PayReq']/field[@name='options']"
		[Register ("options")]
		public global::Com.Tencent.MM.Sdk.Modelpay.PayReq.Options options_Rename {
			get {
				if (options_jfieldId == IntPtr.Zero)
					options_jfieldId = JNIEnv.GetFieldID (class_ref, "options", "Lcom/tencent/mm/sdk/modelpay/PayReq$Options;");
				IntPtr __ret = JNIEnv.GetObjectField (Handle, options_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Com.Tencent.MM.Sdk.Modelpay.PayReq.Options> (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (options_jfieldId == IntPtr.Zero)
					options_jfieldId = JNIEnv.GetFieldID (class_ref, "options", "Lcom/tencent/mm/sdk/modelpay/PayReq$Options;");
				IntPtr native_value = JNIEnv.ToLocalJniHandle (value);
				JNIEnv.SetField (Handle, options_jfieldId, native_value);
				JNIEnv.DeleteLocalRef (native_value);
			}
		}
...
#pragma warning restore 0169
		...
		[Register (".ctor", "()V", "")]
		public PayReq () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
