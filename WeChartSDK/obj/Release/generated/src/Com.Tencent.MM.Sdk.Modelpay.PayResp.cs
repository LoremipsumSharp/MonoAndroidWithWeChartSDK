...
namespace Com.Tencent.MM.Sdk.Modelpay {
	...
	public partial class PayResp : global::Com.Tencent.MM.Sdk.Modelbase.BaseResp {
		...
		[Register (".ctor", "()V", "")]
		public PayResp () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public PayResp (global::Android.OS.Bundle p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
