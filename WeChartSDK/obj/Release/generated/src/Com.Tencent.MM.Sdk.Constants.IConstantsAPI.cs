...
namespace Com.Tencent.MM.Sdk.Constants {
	...
	public sealed partial class ConstantsAPIToken : global::Java.Lang.Object {
		...
		[Register (".ctor", "()V", "")]
		public ConstantsAPIToken () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
	...
	public sealed partial class ConstantsAPIWXApp : global::Java.Lang.Object {
		...
		[Register (".ctor", "()V", "")]
		public ConstantsAPIWXApp () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
	...
	[System.Obsolete ("Use the 'ConstantsAPI' type. This type will be removed in Mono for Android 5.0.")]
